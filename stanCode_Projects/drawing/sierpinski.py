...
def main():
	"""
	TODO:This project draw an amazing triangle!!
	"""
...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	"""
	:param order:int, layers of triangles
	:param length:int, length of triangle
	:param upper_left_x:int, the x of triangle's upper-left
	:param upper_left_y:int, the y of triangle's upper-left
	:return:
	"""
	if order == 0:
		return
